...
public class RandomAccessDemo
{
  public stati void main(String args[])
  {
    try
    {
       ...
       ioStream.seek(1);
       oneByte = ioStream.readByte();
       Stsyem.out.println("The value at location 1 is " + oneByte);
       Stsyem.out.println("Now we go to the end of the file");
       Stsyem.out.println("and write a double.");
       ioStream.seek(ioStream.length());
       ioStream.writeDouble(41.99);
       System.out.println("The length of the file is now = " + ioStream.length() ) ;
       System.out.println("Returning to the location 3. ") ;
      ...
      {
        System.out.println("Promblm with  file I/O.") ;
      }
      System.out.println("End of prigram") ;
    }
  }
}